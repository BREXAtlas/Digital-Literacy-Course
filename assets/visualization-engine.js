...
const VISUALS = {
  ...
  ep06: { title: "A focused help request", type: "flow", items: ["Explain the context", "Show what you checked", "Name the exact problem", "Ask one specific question"], summary: "A focused request makes the situation, prior effort, exact obstacle, and needed help clear." },
  ...
  ep12: { title: "Keep three kinds of writing separate", type: "compare", items: ["Direct quote — exact words and quotation marks", "Paraphrase — your wording with citation", "Your analysis — your reasoning connected to evidence"], summary: "Quotes, paraphrases, and original analysis should be visibly separated in notes and drafts." },
  ep13: { title: "Student account security layers", type: "layers", items: ["Unique passphrase", "Password manager", "Multi-factor authentication", "Recovery and login alerts"], summary: "Account security works in layers: unique credentials, secure storage, MFA, and monitored recovery methods." },
  ...
  q07: { title: "AI-supported writing with student authorship", type: "flow", items: ["Brainstorm", "Student outline", "Student draft", "AI feedback", "Student revision and verification"], summary: "Student authorship remains central when AI supports brainstorming or feedback but the student drafts, revises, and verifies." },
  ...
  q12: { title: "Authorship evidence trail", type: "flow", items: ["Your question", "Your notes and sources", "Your draft history", "Documented AI support", "Your final explanation"], summary: "An authorship trail connects the student's question, notes, drafts, disclosed support, and ability to explain the final work." },
